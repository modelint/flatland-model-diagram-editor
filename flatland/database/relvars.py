...
def define(db) -> dict:
    ...
    return {
        ...
        'metadata_stack_order': Table('Meta Data Stack Order', db.MetaData,
                                      Column('Metadata', Text, ForeignKey('Meta Data.Name', name='R319_M'),
                                             nullable=False),
        ...
        'open_field': Table('Open Field', db.MetaData,
                            Column('Metadata', Text, ForeignKey('Meta Data.Name', name='R305_R307_M'), nullable=False),
                            ...
                            PrimaryKeyConstraint('Metadata', 'Location', 'Frame', 'Sheet', name='I1'),
                            ForeignKeyConstraint(('Frame', 'Sheet'), ['Frame.Name', 'Frame.Sheet'],
                                                 name='R305_R307_F'),
                            ),
