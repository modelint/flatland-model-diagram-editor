...
"""
population = [
    # Only one title block for now, measurements in mm
    # {'Frame': 'OS Engineer', 'Sheet': 'letter', 'Orientation': 'landscape',
    #  'Title block pattern': 'SE Simple', 'Sheet size group': 'medium', 'X': 190, 'Y': 9},
    # {'Frame': 'OS Engineer', 'Sheet': 'letter', 'Orientation': 'portrait',
    #  'Title block pattern': 'SE Simple', 'Sheet size group': 'medium', 'X': 120, 'Y': 9},
